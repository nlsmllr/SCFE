    ...
    <html className='html text-white flex flex-col items-center justify-center min-h-screen'>
      <body>
        ...
        <div className="px-14">
          ...
          <br />
          <h2 className='text-2xl font-bold underline'>Interpretation and Definitions</h2>
          <br />
          <h3 className='text-xl font-bold underline'>Interpretation</h3>
          <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
          <br />
          <h3 className='text-xl font-bold underline'>Definitions</h3>
          ...
          <ul>
            ...
            <li>
              <p><strong>Application</strong> refers to Smart Cities Wedel, the software program provided by the Company.</p>
            </li>
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Smart Cities Wedel.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Smart Cities Wedel, accessible from <a href="https://scfe.vercel.app/" rel="external nofollow noopener" target="_blank">https://scfe.vercel.app/</a></p>
            </li>
            <li>
          ...
          <br />
          <h2 className='text-2xl font-bold underline'>Collecting and Using Your Personal Data</h2>
          <br />
          <h3 className='text-xl font-bold underline'>Types of Data Collected</h3>
          <br />
          <h4 className='text-xl font-bold underline'>Personal Data</h4>
          ...
          <br />
          <h3 className='text-xl font-bold underline'>Use of Your Personal Data</h3>
          ...
          <br />
          <h3 className='text-xl font-bold underline'>Retention of Your Personal Data</h3>
          ...
          <br />
          <h3 className='text-xl font-bold underline'>Delete Your Personal Data</h3>
          ...
          <br />
          <h3 className='text-xl font-bold underline'>Disclosure of Your Personal Data</h3>
          <br />
          <h4 className='text-xl font-bold underline'>Business Transactions</h4>
          <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
          <br />
          <h4 className='text-xl font-bold underline'>Law enforcement</h4>
          <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
          <br />
          <h4 className='text-xl font-bold underline'>Other legal requirements</h4>
